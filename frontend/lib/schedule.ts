...
/** US federal holidays (YYYY-MM-DD). Extend as needed. */
export const SCHEDULE_HOLIDAYS = new Set([
  "2025-01-01",
  "2025-01-20",
  "2025-02-17",
  "2025-05-26",
...
export function isHoliday(dateStr: string): boolean {
  return SCHEDULE_HOLIDAYS.has(dateStr);
}
...
export function isBookingDateAllowed(dateStr: string): boolean {
  if (!isWeekday(dateStr) || isHoliday(dateStr)) return false;
